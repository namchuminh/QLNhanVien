                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="simpleinput" class="form-control" placeholder="Tên chức vụ" required="" name="tenchucvu" value="<?php echo $detail[0]['TenCV'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="simpleinput">Mô Tả</label>
                                                <input type="text" id="simpleinput" class="form-control" placeholder="Mô tả" required="" name="mota" value="<?php echo $detail[0]['MoTa'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="simpleinput">Lương Cơ Bản</label>
                                                <input type="number" id="simpleinput" class="form-control" placeholder="Lương cơ bản" required="" name="luongcoban" value="<?php echo $detail[0]['LuongCoBan'] ?>">
                                            </div>
